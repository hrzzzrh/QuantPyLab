...
**命令格式：**
```bash
uv run skills/financial-report-downloader/scripts/download_reports.py <股票代码> <下载目录> [数量]
```
...
- **指令**：`uv run skills/financial-report-downloader/scripts/download_reports.py 300274 workspace/sunpower 12`

- **请求**：“下载紫金矿业 (601899) 最近 3 份报表到 reports 文件夹。”
- **指令**：`uv run skills/financial-report-downloader/scripts/download_reports.py 601899 reports 3`
