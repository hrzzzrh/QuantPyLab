...
> 研究日期：2026年8月2日
> 数据截至：2026年8月2日。公司披露的最新可复核经营口径仍主要为 OpenAI 于 2026 年 1 月披露的 2025 年 ARR（$20B+）以及 Anthropic 于 2026 年 5 月披露的 run-rate revenue（$47B）；两者均非审计财报。
...
**美国 AI 基建正经历高强度扩张，存在产能错配与融资顺周期风险，但公开数据尚不足以把全行业定性为已发生的“产能泡沫”。** 2026年二季度，Alphabet 披露 Google Cloud 收入同比增长82%，Microsoft 披露 Azure 收入增长45%且年度 Azure 收入首次超过$100B，说明部分需求已经商业化；同时，资本开支、合同承诺和最终客户 ROI 的匹配度仍需跨周期检验。产业链高度耦合意味着下游需求或融资收缩会传导至上游，但 Cisco 是风险类比，不是结果预测。

### 核心发现

1. **需求与投资的可比口径仍有验证缺口**：模型公司披露的 ARR/run-rate、云厂商收入和超大规模企业的总资本开支并非同一口径，不能直接相除以证明投资无效。最新季度的云收入增长提供了需求证据，但尚不能回答全部 AI 投资的长期回报率。
2. **三层风险传导链值得持续监测，但不能被当作已量化的“债务超结构”**：超大规模企业的高资本开支、模型公司的长期算力承诺和私募信贷融资之间存在潜在的顺周期放大关系；不过，公开资料不足以验证 OpenAI 的具体承诺金额、私募信贷中 AI 交易占比或三层规模的精确拆分。FSB 的正式结论是私募信贷与银行、保险和私募股权的关联加深，并非针对 AI 给出集中度定量结论。
...
| 指标 | 数字 |
|------|------|
| 2026年超大规模企业资本开支 | 多家机构估计为$600B以上；含非AI云、网络和其他基础设施，不能等同为AI CapEx |
| OpenAI已公开确认口径 | 2025年ARR超过$20B（公司口径，非审计确认营收） |
| Anthropic已公开确认口径 | 2026年5月run-rate revenue超过$47B（公司口径，非审计确认营收） |
| 已观察到的云端需求 | Google Cloud 2026年Q2收入同比+82%；Azure 2026年Q4收入同比+45%、年度收入首次超过$100B |
| **可得结论** | **需求增长和投资加速同时存在；尚无公开分部数据可可靠计算“AI营收/AI CapEx”回报率。** |
...
| Microsoft RPO | $627B（FY2026 Q3） | 公司确认剔除其最大单一AI商业合同后RPO仍增长26%，但未公开披露客户名称或金额 |
...
- Microsoft FY2026 Q3 Commercial RPO 为$627B；公司确认其中存在最大单一AI商业合同，但未公开客户、金额或履约条款
...
| FSB 发现 | 数据 |
|----------|------|
| AI/数据中心相关交易占私募信贷比例 | **未见 FSB 正式披露的可复核比例**；原 34%/17% 仅来自非官方二次转述，不能作为基准 |
| 通过私募信贷投入 AI 的预估资金 | **未获权威来源独立验证**；不作为压力测试的定量输入 |
...
| 时间 | 事件 | 意义 |
|------|------|------|
| 2026年8月起 | OpenAI、Anthropic 是否公开提交注册文件 | 两家公司此前披露或媒体所称的保密递表不能替代公开 SEC 文件；在公开招股书出现前，实际确认营收、毛利率、现金流和合同承诺均不能视为已验证。 |
...
40. Financial Stability Board. "Report on Vulnerabilities in Private Credit." 6 May 2026. [FSB](https://www.fsb.org/2026/05/report-on-vulnerabilities-in-private-credit/). 该报告确认私募信贷规模约 $1.5–2.0T（截至2024年末）、银行关联与估值/流动性风险，未给出 AI 交易占比的正式统计。
41. OpenAI. "A business that scales with the value of intelligence." 18 January 2026. [OpenAI](https://openai.com/index/a-business-that-scales-with-the-value-of-intelligence/). 公司披露 2025 年 ARR 超过 $20B。
42. Anthropic. "Anthropic raises $65B in Series H funding at $965B post-money valuation." 28 May 2026. [Anthropic](https://www.anthropic.com/news/series-h). 公司披露 2026 年 5 月 run-rate revenue 超过 $47B。
43. Alphabet. "Alphabet earnings call Q2 2026." 22 July 2026. [Google](https://blog.google/company-news/inside-google/message-ceo/alphabet-earnings-q2-2026/). 公司披露 Google Cloud 收入同比增长82%。
44. Microsoft. FY2026 Q4 results, 29 July 2026. [Microsoft](https://www.microsoft.com/en-us/investor). 公司披露 Azure年度收入首次超过$100B；Azure季度收入增长45%。

---

*本报告基于公开可获取的信息进行分析，不构成任何投资建议。所有数据和观点截至2026年8月2日。*
